      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-violet-600 text-lg font-bold uppercase tracking-widest mt-1">Timeline · {patient.name} · {patient.gender} · {patient.age}岁{patient.ageMonth !== undefined ? ` ${patient.ageMonth}个月` : ''} · {patient.patientNo || patient.idCard || '无编号'}</p>
          </div>
        </div>
      </div>
